...
const Home: React.FC = () => {
  ...
  const web3 = new Web3(new Web3.providers.HttpProvider("https://ropsten.infura.io/v3/09f83bea7fbc4b3d805873592177712b"));
  const presaleContract = new web3.eth.Contract((ERC20ABI as unknown) as AbiItem, '0xe9DCB01c2c5C2129e39E03746CD25f2376fAdD4f');
  ...
  const depositEther = () => {
    console.log("deposit : ", presale, account, depositInput);
    ...
    <div>
        <Page>        
          <div style={{ display: isDesktopOrLaptop? "grid" : "block", gridTemplateColumns: "repeat(3, 1fr)", gridGap: 20 }}>
            <div></div>
            <PageHeader
              icon={<img style={{ width: 270, borderRadius: 25 }} src={mainImg} />}
              maintitle=""
              title="BROWNIE Presale"
          ...
          <div style={{display: isDesktopOrLaptop?'flex':'block', width: isDesktopOrLaptop?1072:'auto', margin: isDesktopOrLaptop?"40px auto auto auto":"40px auto"}}>
            <StyledContainer>
              ...
              <div style={{marginTop:'36px', padding:'12px 0', display:'grid', borderBottom:'1px solid rgba(0, 0, 0, 0.3)', }}>
                ...
                <span className='boldFont'>1 BNB = 10000000 BROWNIE</span>
              </div>
            ...
            <StyledContainerR>
              ...
              <div style={{display:'flex', marginTop:'8px', marginBottom:'24px'}}>End Time: </div>
