...
const Balances: React.FC = () => {
  ...
  // const presaleContract = new web3.eth.Contract((ERC20ABI as unknown) as AbiItem, '0x5382F19A95a56C39746ce65808afDc3AecBE7596');
          ...
          <div style={{ flex: 1, }}>
            <div style={{display: 'flex', placeContent:'center'}}>
              ...
              <Value
                value={depositAmount}
              />
              <Label text=" BNB / 100 BNB" />
            </div>
            <div className={classes.root}>
              <PrettoSlider className='' key={`PrettoSlider-${depositAmount}`}
                valueLabelDisplay="off" defaultValue={depositAmount} min={0} max={100}
